...
export class MonthlyCollectionComponent implements OnInit {
  ...
  constructor(private formBuilder: UntypedFormBuilder, private router: Router, private route: ActivatedRoute, private http: HttpClient, private reportService: BillingReportService,
