...
@NgModule({ declarations: [
    ...
    bootstrap: [AppComponent], imports: [BrowserModule,
        ...
        ServiceWorkerModule.register('ngsw-worker.js', { enabled: environment.production })], providers: [ExceptionhandlerService, AppGlobals, provideHttpClient(withInterceptorsFromDi())] })
